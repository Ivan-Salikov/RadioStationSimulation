...
Приложение состоит из 5 окон:

| Окно | Описание |
|------|----------|
| **Симуляция** | Управление запуском, параметры моделирования, статистика |
| **Фонотека** | Управление музыкальной библиотекой (добавление, поиск, удаление треков) |
| **Радиопрограммы** | Создание и настройка программ обоих типов |
| **О программе** | Диалоговое окно с информацией о проекте |
| **Руководство** | Краткая инструкция пользователя |
